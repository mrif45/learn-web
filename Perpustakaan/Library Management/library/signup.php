...
if (isset($_POST['signup'])) {
    ...
    if ($_POST["vercode"] != $_SESSION["vercode"] or $_SESSION["vercode"] == '') {
        ...
        $status = 1;
        $sql = "INSERT INTO  siswa(id_siswa,nama_siswa,no_telp,email,Password,Status) VALUES(:id_siswa,:fname,:mobileno,:email,:password,:status)";
        ...
        if ($lastInsertId) {
            echo '<script>alert("Your Registration successfull and your student id is  "+"' . $id_siswa . '")</script>';
        } else {
