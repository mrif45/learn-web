...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update siswa set nama_siswa=:fname,no_telp=:mobileno where id_siswa=:sid";
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post">
                                <?php
                                $sid = $_SESSION['stdid'];
                                $sql = "SELECT id_siswa,nama_siswa,email,no_telp,tgl_reg,tgl_update,Status from  siswa  where id_siswa=:sid ";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':sid', $sid, PDO::PARAM_STR);
                                $query->execute();
